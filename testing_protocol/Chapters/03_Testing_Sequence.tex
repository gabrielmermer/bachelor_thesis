...
After 10 minutes the resercher switches the navigation to voice input mode by using the keyboard. The prototype is not restarted,
instead the player is instruced to continue his playthrough using voice. The decision not to restart is placed to reduce any frustration that the player
...
The moements that stood out during testing marked with timestamps.
\begin{table}[h]
\centering
