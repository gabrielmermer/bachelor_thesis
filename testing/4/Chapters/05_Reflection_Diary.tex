...
\begin{QandA}
   \item Wait time \& silence: Did I provide the participant with time and space to voice out their opinions or did I fill the silence gap due to my own discomfort?
        \begin{answered}
            I gave the particpant 1-2 seconds of wait time in between asking them.
        \end{answered}

   \item Lexical mirroring: Identify 1-2 times where I used participants own words to deepen his narrative and answer.

        \begin{answered}
        In this interview there was no lexical mirroring that could be observed.
        \end{answered}
    ...
    \item The "Vessel trap": Did I treat the participant as a way to prove my internal bias that this system might be more immersive than traditional input?
        ...
        \begin{answered}
            I made sure not to treat the participant as a vessel to prove any of my biases.
        \end{answered}
\end{QandA}
...
\begin{QandA}
    ...
    \begin{answered}
        I'm happy with the revered order of baseline and novelty versions of the game. I'll be keeping it going forward as it helps to reduce the modality carry-over effect that I've noted on in last 3 participants.
    \end{answered}
\end{QandA}