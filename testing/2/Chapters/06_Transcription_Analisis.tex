...
\begin{enumerate}
    \item Kacper seems to be enjoying the open-ended nature of voice control
    \item Voice commands were issued starting with "Let's" implying collaborative nature.
    \item After switching to voice interaction the player tried interacting with objects that he couldn't before
    \item The participant said unprompted that the keyboard version allowed for speedruning the game without having to read any descripions.
    \item Voice recoginition faliures were interepreted as intentional game design and a form of breaking the "fourth wall"
    \item The participant stated that he couldn't have completed the voice version fully had he not played the keyboard version first to familiarise himself with the game.
    \item The player chose the voice input modality over they keyboard despite the bugs that he encountered, citing the feeling of freedom and satisfaction of open-ended problem solving as his primary reasons
...
\begin{enumerate}
    \item Collaborative command creation
    
        \begin{quote}
            "Let's go to the clothing store", "Let's pick up the crowbar"
        \end{quote}
        Consistent use of the word "Let's" made the commands feel issued collaboratively with the computer, not a cold instruction.
    

    \item Stress testing
    
        \begin{quote}
            "Can I now take something else from the room that wasn't possible earlier?"
        \end{quote}
        Testing for the possiblity of expanded agency immediately, from a position of curiosity not anxiety. 
    

    \item Action menu as disengagement device 
    
        \begin{quote}
            "There's almost no need to read the text. You could just speedrun through the buttons." 
        \end{quote}
        The list of possible actions seem to make it possible to skip reading any game descriptions and instead try to finish the game quicker than intended.


    \item Agency as freedom
    
        \begin{quote}
           "It was more like a freedom that I could think of another solution. I could try something else."
        \end{quote}
        The player enjoyed the fact that he could try to create solutions outside the box and actively tried solving the game puzzles with his imagination. 
    

    \item Sequence dependency
    
        \begin{quote}
           "If I played it the other way around, I don't think I could find the brother in the speaking one."
        \end{quote}
        The prior experience with the text based naviagation was considered as a prerequesite for the voice version.        


    \item Conversation metaphor
    
        \begin{quote}
           "When you talk to the computer you feel like you have a conversation with the game."
        \end{quote}
        The sole fact of talking to the computer made playing the game feel more like a conversation than a solo playthrough experience.      
...
Similar to the test \#1 the player seemed to carry his notions about the text based input modality into the voice interaction version. He claimed that the text based playthrough has been essential to his success in navigating the voice interaaction version of the game. This is something that should be tested. 



\subsubsection{B - Friction absorbtion}

The player reported to have explained the errors in the voice recognition as a potential breaking of the "fourth wall". This kept him in the state of suspended disbelief. 
On top of that he was okay with the game not letting him do some of the actions that he wanted to do, quoting that he still enjoyed the process of trying to solve problems in a creative manner.


\subsubsection{C - Predictibility vs Investment}

Kacper articulated that in the keyboard based version he could skip reading the location descriptions entirely and focus purely on completing the game as quickly as possible.
He also noted that the contrary effect taken place during the voice input version since he had to pause and read the descriptions fully to even understand what was possbile for him to do in any given moment.


\subsubsection{D - Agency as freedom}

The open-ended nature of voice input was experienced as something with a higher agency and puzzle-solving potential compared to text based navigation. Kacper's gaming background shines through here, making him seek out emergent item interactions and actions that are not typical. His command language "Let's" suggests that he entered this space in an collaborative explorative manner, rahter than being a cautious user. 
...
During this session this theme answers mostly the question \#1 since it touches on the experience of the participants using their voice as a navigation tool. The difference between the input modalites is naturally highlighted here due to both of those input methods being compared and one influencing the other. 
...
% The player reported to have explained the errors in the voice recognition as a potential breaking of the "fourth wall". This kept him in the state of suspended disbelief. 
% On top of that he was okay with the game not letting him do some of the actions that he wanted to do, quoting that he still enjoyed the process of trying to solve problems in a creative manner.
This theme fits both of the research questions since it showcases how the participant background can influence his perception of using the voice, in this case making the voice input modality seem to work better than it does. 
...
Theme C also directly answers the research questions, since the participant is describing his feelings of investment and detatchment from the game, and bases them on the versions of the game that he played. 

\subsubsection{D - Agency as freedom}

% The open-ended nature of voice input was experienced as something with a higher agency and puzzle-solving potential compared to text based navigation. Kacper's gaming background shines through here, making him seek out emergent item interactions and actions that are not typical. His command language "Let's" suggests that he entered this space in an collaborative explorative manner, rahter than being a cautious user. 

The theme D also represents both of the research questions since it tackles not only the experience of using the voice interacion modality and the feeling of freedom through ambigousity, but also touches on how that feeling is absent in the keyborad-driven version of the game. 
...
Similar to the test \#1 the player seemed to carry his notions about the text based input modality into the voice interaction version. Despite trying new and untested behaviour in the voice interaction version he stil claimed that the text based playthrough has been essential to his success in navigating the voice interaction version of the game. In order to sucessfully complete a game the player needs to feel in control of his experience. Knowledge of possible actions, at least some of them, combined with empirical experience of having played the game a little bit before trying the voice version builds scaffolding that the player described as essential for his further success. What begs to be tested here is exposing the player into the game environment without having them played the text navigation version first.
...
When the voice recoginion system failed the player internalised that as a choice made by the game developer in adavnce in a humourous way. When the voice interaction system failed the participant thought that instead of a faliure he got exposed to some kind of deeper secret layer of sense in the game. There are games out there that use this type of interacion, eg. Undertale. In those experiences the game reminds the player that it's aware of them playing, and sometimes breaks it's own systems in order to communitcate with the player directly. What makes this theme interesting is that it's completely unexpected. Kacper was the only participant with this interpretaiton, despite being not the only one with the game design background. This in itself leads his unique perspective on the experience that he played though. 

This in itself reduced the frustation compared to the session \#1, where the participant took all of the pain points as they were - friction. 


\subsubsection{C - Disengagement vs Investment}

Kacper articulated that in the keyboard based version he could skip reading the location descriptions entirely and focus purely on completing the game as quickly as possible.
He noted that this made him disengageged since he didn't have to read any of the text and could just focus on completing the game as fast as he could. There are players that seem to focus deeply on the speed of finishing games and his behavour is a direct proof of that.


He also noted that the contrary effect taken place during the voice input version since he had to pause and read the descriptions fully to even understand what was possible for him to do in any given moment. This forced him to be deeply engaged with the game, since now he needed fo deeply focus just to be able to take any action in the game. This design choice leaves the player with no choice. Kacper intereprets that as a feature not a cost, since in his eyes the fact the game forces his attention makes it a more interesting experience.


\subsubsection{D - Agency as freedom}

The open-ended nature of voice input was experienced as something with a higher agency and puzzle-solving potential compared to text based navigation. Kacper's gaming background shines through here, making him seek out emergent item interactions and actions that are not typical. He took pleasure in exploring different options and really wanted to see what would be possible. The sheer scope of different attempts that he made showcases that he really viewed the voice input not as a constraint but rather as a tool of a much expanded agency. Despite the voice based game not offering him more options compared to the keyboard navigation experience he persisted in trying new input options.

His command language "Let's" suggests that he entered this space in an collaborative explorative manner, rahter than being a cautious user. 
...
Similar to the test \#1 the player seemed to carry his notions about the text based input modality into the voice interaction version. Despite trying new and untested behaviour in the voice interaction version he stil claimed that the text based playthrough has been essential to his success in navigating the voice interaction version of the game. 

\begin{quote}
    “If I played it the other way around, I don't think I could find the brother in the speaking one.”
\end{quote}

In order to sucessfully complete a game the player needs to feel in control of his experience. Knowledge of possible actions, at least some of them, combined with empirical experience of having played the game a little bit before trying the voice version builds scaffolding that the player described as essential for his further success. What begs to be tested here is exposing the player into the game environment without having them played the text navigation version first.
...
\begin{quote}
    "For a moment I thought about it like it could be intended as such — like have fun with the player, to invert expectations a bit. It's like a breaking of a fourth wall kind of thing. But maybe it's just my imagination running wild."
\end{quote}
...
\begin{quote}
    "Yes, I did [enjoy it]. And one of the things is that it was a new experience to me and it was fun to try something new. A new way to play a game."
\end{quote}
...
\begin{quote}
    "The second one is like, you need to be taken in the story to be able to play it, because without reading and being invested somehow in this world, you cannot even move forward. So if I would want to play one of those games, I would want to play the second one."
\end{quote}

This design choice leaves the player with no choice. Kacper intereprets that as a feature not a cost, since in his eyes the fact the game forces his attention makes it a more interesting experience.
...
\begin{quote}
    "Can I now take something else from the room that wasn't possible earlier, or shouldn't I try it at all?"
\end{quote}

When asked directly whether the freedom to say anything was overwhelming, his answer proved the observations:

\begin{quote}
    "It wasn't overwhelming for me. It was more like a freedom that I could think of another solution. I could try something else. I really like in other video games when you can pick some random item at the beginning and then two hours later it turns out you can do something with it. So when I don't have a strict list of things I can do, I can have that feeling."
\end{quote}

His command language "Let's" suggests that he entered this space in an collaborative explorative manner, rather than being a cautious user. 

\begin{quote}
    "When you talk to the computer you feel like you have a conversation with the game, so it's also pretty interesting. But you need to be more focused, you cannot rely on the game telling you what to do."
\end{quote}
