...
\textbf{Physical comfort} How is the participant feeling & The participant feels comfortable \\[1.5cm] \hline
\textbf{Natural language observation} (is the player using long sentences or simple commands? What type of language do they use? Are they speaking first or 3rd person?) & The participant is using simple and direct commands from first person. \\[1.5cm] \hline
\textbf{Linguistic guessing} (is the particpant trying to guess the possible commands by speaking to the game?) & The player is making guesses and actively trying to seek where boundaries lie. \\[1.5cm] \hline
\textbf{Processing time user reaction} (Does the wait time break the suspension of disbelief) & There seems to be a small impact on that. \\[1.5cm] \hline
...
\hline
\textbf{Field} & \textbf{Response} \\ \hline
\textbf{Physical comfort} How is the participant feeling & The player looks equally comfortable as in the audio version.\\[1.5cm] \hline
\textbf{Immersion markers} (flow \& frustration) & The participant is deep in the experience.\\[1.5cm] \hline
\end{tabular}
\end{table}
