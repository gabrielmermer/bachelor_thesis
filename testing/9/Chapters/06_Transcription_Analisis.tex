...
\subsubsection{A - Observer effect}

In the realm of physics the Observer effect is the paradox in which the act of obsercation changes the outcome. Mariusz noted that the presence of the researched made him feel uncomfortable and altered his feeling and perception of the game. 

\subsubsection{B - Deep, unprefered immerison}

Mariusz noted directly that he preffered the keyboard driven verison of the game, but that the voice input version was more immersive due to the fact that it needed his full attention. 
This goes hand in hand with some previous participant's observations.


\subsubsection{C - False agency}

The participant made a remark on the fact that the game gives a false sense of agency - allowing the player to speak any command but not guaranteeing that it would understand him. 
This is also a finding that correlated with some other players.

\subsubsection{D - Describing descriptions}

Mariusz offered a clear design feedback on how the descriptions should be handled. The text should match the agency 1:1 in his perspective. If the location is just a corridor linking two places, it should be a short sentence, if it's a complex location the text should be correspondingly longer, but not contain any unneeded information. 
...
In the realm of physics the Observer effect is the paradox in which the act of obsercation changes the outcome.
Same principle can be observed during research. No matter how good is the setting, how professional the researcher and how used to being tested the participant is it's still fundamentally a different experience compared to not being tested while playing the game (in this context). This fundamentally alters the results a little bit and Mariusz made sure to point that out.

Him and Wiktoria were the two participants who voiced their opinion on the impact of being participants on their feelings, particularly pointing towards performance anxiety 

Mariusz noted that the presence of the researched made him feel uncomfortable and altered his feeling and perception of the game. 


\subsubsection{B - Deep, unprefered immerison}

Mariusz noted directly that he preferred the keyboard driven version of the game, but that the voice input version was more immersive due to the fact that it needed his full attention. He used the word "paradoxically" which is the most direct description of this effect that was observed with some previous participants, who also noted similar observation. 

It should be observed that he acknowledge both the fact that he preferred the keyboard version while he felt deeper in the experience while playing the voice input version. This on its own is also interesting since going into this study the researcher had the assumption that participants would correlate their preference with deeper immersion, but that does not seem to be the case.


\subsubsection{C - False agency}

The participant made a remark on the fact that the game gives a false sense of agency - allowing the player to speak any command but not guaranteeing that it would understand him. 
This is also a finding that correlated with some other players. The trope of having a sense of false agency comes up again and again in the study sample. What stands out here is the fact that he both recognises the false nature of the agency while claiming that he could recognise feeling more in control. This cognitive dissonance is an interesting finding on his perception of the input modalities. 
...
Mariusz offered a clear design feedback on how the descriptions should be handled. The text should match the agency 1:1 in his perspective. If the location is just a corridor linking two places, it should be a short sentence, if it's a complex location the text should be correspondingly longer, but not contain any unneeded information. He noted how in the current version of the game big portions of the text offered no interaction behind it, which created a feeling of false affordances described in theme C. This is another interesting theme since the descriptions in a text based game serve two main purposes: the navigational one, and narrarive building. He clearly stated that the game should skew more towards that functional-navigational path not to be confusing. 
...
\begin{quote}
    "Dziwnie, to nie jest takie codzienne.
    Zwłaszcza przy jakimś...
    Siedzi przy łóżku.
    Bardzo blisko, więc trochę czuję się oceniający.
    Ale to chyba... Tak, rozumiem.
    Dziwnie też gadać do kompa, zawsze, dla mnie."
\end{quote}
...
\begin{quote}
    "Powiedzmy, że w pierwszej właśnie z głosem akurat, jakby paradoksalnie, no bo musiałem się bardziej skupić i przeczytać wszystko i pomyśleć to, co ja robię i to mówić."
\end{quote}
...
\begin{quote}
    "Miałem taką, znaczy można odczuć wrażenie, że się ma taką większą kontrolę nad grą, nad tym co się robi, ale ona jest dosyć fałszywa, no bo wiadomo, że nie może zrobić wszystkiego aż tak dobrze jak nie jest zaprojektowane."
\end{quote}
