...
Marcel used very poetic and expressive commands with greats ammounts of detail. This is very different from most participants.


\subsubsection{B - Immagination boolean}

The participant noted how the usage of voice commands made him much more present in the game and forced him to use his imagination.

\subsubsection{C - Intent vs reponse gap}

Due to how expressinve and precise the commands of the participant were there was a noticeable gap between what the player asked the game for and what could be delivered. This is the first player that goes so deep with his commands aside from \#2 in the beginning.

\subsubsection{D - Novelty as engagement fuel}

Marcel claims that the game is much more interesting and captivating for him due to the fact that the voice input modality is new for him compared to keyboard based navigation. This is an interesting finding that goes well with other participants.
...
This theme goes hand in hand with two presented research questions since as discussed previously the language of commands used shapes the relationship between the participant and the computer which in turn changes the game experience and the feelings attached to it.
...
Feeligns of heightened immersion and activation of imagination directly correlate with the presented research questions. 

\subsubsection{C - Intent vs reponse gap}

% Due to how expressinve and precise the commands of the participant were there was a noticeable gap between what the player asked the game for and what could be delivered. This is the first player that goes so deep with his commands aside from \#2 in the beginning.

This theme also fits the research questions since the friction and pain points directly impact the feelings of participant.

\subsubsection{D - Novelty as engagement fuel}

% Marcel claims that the game is much more interesting and captivating for him due to the fact that the voice input modality is new for him compared to keyboard based navigation. This is an interesting finding that goes well with other participants.

This part also fits the research question since the participant directly talks about his feeling of engagement and compares it to traditional input with associated feelings.
...
This interaction style was much closer to being an author much rather than just issuing commands to the computer. He often pushed for things that were much beyond what's possible.

The fact that the system could not always honour these elaborate requests left him feeling that the experience had something to be desired, but that didn't eliminate the pleasure he took from creating these commands (especially when they worked). The made him feel more present in the game in this way compared to traditional input.
...
Since the commands Marcel used were so nuanced and complicated the system couldn't fully comply with them the way he wanted. Even if the basic intent of a command was fufiled the details that he wished couldn't be executed as this layer of precision was simply not implemented.
