...
human voice in near real time \parencite{DavabaseWhisper_real_timeReal2022}. That natural language transcription would be interpreted by an \textcite{LargeLanguageModel2025} with direct access to
the game engine. Such deep integration could produce an input method that’s more flexible than traditional voice commands
for navigation. 

This paper will focus on a game environment similar to a pen and paper \textcite{RPGNounDefinition2025} game, since players tend to have a variety
