...
This effect persisted even after the test order was reversed. The players who hadn't seen the keyboard version still used their past experiences to shape their interaction with the game. This implies that the modality transfer is not purely an effect of the A/B testing sequence. This finding is consistent with the above citation. \todo{another citation}
...
This suggests that participants are not treating the voice input as a deterministic input method; they look at it as an input modality that has an inherent non-linear social element to it. This seems to align with the existing literature \cite{interactiondesignfoundationWhatAreVoice2025}, which says that since the role of voice communication is so essential in human interaction, people can't fully disregard the social expectations and frameworks of voice interaction, including the different ways of framing commands. 
...
Existing literature indicates that both in the cases of voice-related frustration and the feelings of overload, the personal response varies between individuals, proving this finding but not offering an answer to why that is \cite{harneskExploringVoiceInteractions}.
...
Despite the mentioned complexity and friction, all of the participants agreed on the fact that the input modality had a profound impact on their feeling of immersion in the game, be it positive or negative; it left a mark.