...
This chapter expands on the findings from the Results section. It takes each of the found Categories and draws suggestions. 
Each of the Categories is also checked for their alignment with existing literature.
