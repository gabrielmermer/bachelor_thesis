...
This chapter expands on the findings from the Results section. It takes each of the found Categories and draws suggestions from them. 
Each of the Categories is also checked for their relationship with existing literature.
...
The fact that this effect persisted even after the test order was reverse implies that the modality transfer is not purely an effect of the A/B testing sequence.
...
% Given that some participants claimed both a higher degree of immersion in the voice-driven game and not choose that version, quoting frustration caused by friction, suggests that friction might not be a reliable predictor of immersion. 
...
Above suggestions indicate that creating immersive experiences might prove to be a real challenge for game designers.
