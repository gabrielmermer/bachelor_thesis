...
\begin{itemize}
    \item ``autocite'' version \autocite{stoiber_visualization_2023}
    \item ``textcite'' version \textcite{tjoa_airman_2022}
\end{itemize}
...
Find attached a citation of a website~\autocite[12]{kaley_match_2018}.
